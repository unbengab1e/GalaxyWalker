...
def parse_args():
    ...
    parser.add_argument("--wandb_project", type=str, default="astro_qwen2")
...
def evaluate_classification(model, accelerator, eval_dataloader, args, global_step):
    """评估分类任务"""
    model.eval()
    task_metrics = {}
    task_predictions = defaultdict(list)
...
def train():
    ...
    if accelerator.is_main_process:
        ...
        wandb.init(project="astro_qwen2", name="smart02")
